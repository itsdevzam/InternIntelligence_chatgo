                  ...
                  children: [
                    Container(
                      ...
                      child: ClipRRect(borderRadius: BorderRadius.circular(100),child:FadeInImage.assetNetwork(fit: BoxFit.cover,
                        placeholder: "assets/logos/splash_logo.png", image: value.ProfileuserData['profileImg'],)),
                    ),
                    SizedBox(height: 10),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Text(
                          value.ProfileuserData['name']??lang_en.dummyName,
                          style: TextStyle(
                            color: Colors.white,
                        ...
                        SizedBox(
                          child: Text(
                            value.ProfileuserData['username']??lang_en.dummyUsername,
                            style: TextStyle(
                ...
                child: Container(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        SizedBox(height: 10),
                        profile_item(title: lang_en.displayName, subtitle: value.ProfileuserData['name']??lang_en.dummyName),
                        profile_item(title: lang_en.username, subtitle: value.ProfileuserData['username']??lang_en.dummyUsername),
